...
export default class EventMessage extends Message {
    constructor(subscriptionId: number, publicationId: number, details: KwArgs, args?: Args, kwArgs?: KwArgs) {
        super(MessageType.EVENT, subscriptionId, publicationId, details, args, kwArgs);
    }
    ...
    public asArray(): any[] {
        const a: any[] = [this._type, this.subscription_id, this.publication_id, this.details];
