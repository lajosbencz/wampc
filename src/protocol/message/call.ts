...
export default class CallMessage extends Message {
    constructor(requestId: number, options: KwArgs, procedure: string, args?: Args, kwArgs?: KwArgs) {
    ...
    public asArray(): any[] {
        const a: any[] = [this._type, this.request_id, this.options, this.procedure];
